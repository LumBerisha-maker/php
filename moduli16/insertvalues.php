<?php 
    ...
    try{
        ...
        (1, 'Lumi', 'LumD', 'Lum@gmail.com', 'Lum123', 'Lum123', 'false'),
       ...
       INSERT INTO movies(id,movie_name,movies_desc,movies_quality,movies_rating,movies_image) VALUES
       (1, 'Spiderman' , 'description', '3D', '10', 'https://tse1.mm.bing.net/th/id/OIP.BLGJCaul5S5p-pBUY_FNTAHaHa?rs=1&pid=ImgDetMain&o=7&rm=3'),

        (2, 'Fast and Furios' , 'description', '3D', '10', 'https://tse3.mm.bing.net/th/id/OIP.b_ceCbZZ-5ENFzsPUf-EAwHaEo?rs=1&pid=ImgDetMain&o=7&rm=3');
